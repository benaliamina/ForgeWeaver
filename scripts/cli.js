...
const contractABI = require("../artifacts/contracts/Forgeweaver.sol/Forgeweaver.json").abi;

program
    .name("forgeweaver-cli")
    .description("CLI tool for Forgeweaver smart contract")
    .version("1.0.0");
