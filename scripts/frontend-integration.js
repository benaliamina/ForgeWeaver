 ...
 * This file demonstrates how to integrate Forgeweaver with a web frontend
 */

// For React/Vue/Angular applications
export class ForgeweaverClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ForgeweaverClient(provider, contractAddress);
